"""Eval: FredMacroDataSource.fetch_raw raising RuntimeError propagates through ingestion.

Verifies that when the FRED adapter raises RuntimeError("FRED unavailable"),
the error surfaces from MacroIngestionService with the original message.
"""
...
class TestFredFailureEval:
    """FRED RuntimeError surfaces through the full ingestion service."""
